...
public class JanelaLogin extends javax.swing.JFrame {
     ...
     */
    public JanelaLogin(MessageManager messageManager, MessageListener messageListener) {
    ...
    private void initComponents() {
        ...
        setLocation((tela.width-448)/2, 200);
        setPreferredSize(new java.awt.Dimension(447, 172));
        setResizable(false);
        setType(java.awt.Window.Type.POPUP);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel1.setText("Simulador de Criptografia - Seja Bem Vindo!");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //Pegar o usuário e a senha que foram digitados
        String nick, pass;
        ...
        messageManager.sendAuthMessage(nick, pass);
     ...
     */
    public static void abrirAutenticacao(MessageManager messageManager, MessageListener messageListener) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JanelaLogin.janelaAtual = new JanelaLogin(messageManager, messageListener);
                JanelaLogin.janelaAtual.setVisible(true);
            }
        });
    }
    
    public void tratarResultadoAutenticacao(int id, String response)
    {
        //Se o id que foi recebido é zero, é porque houve erro, mostrar a mensagem
        if(id==0)
            JOptionPane.showMessageDialog(JanelaLogin.janelaAtual, response, "ERRO", JOptionPane.ERROR_MESSAGE);
        else
        {
    ...
    public static JanelaLogin janelaAtual;
}
